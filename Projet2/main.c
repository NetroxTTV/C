...
void colorGrid(int bombC) {
    if (bombC == 0) {
        printf("\033[1;37m %-1d \033[0m", bombC);
    }
    else if (bombC == 1) {
        printf("\033[1;34m %-1d \033[0m", bombC);
    }
    else if (bombC == 2) {
        printf("\033[1;32m %-1d \033[0m", bombC);
    }
    else {
        printf("\033[1;31m %-1d \033[0m", bombC);
    }
}
